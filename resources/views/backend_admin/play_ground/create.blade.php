                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{ url('play_ground/store') }}" method="post" name="update_admin_password_form" id="update_admin_password_form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ground_location" name="ground_location" value="" required placeholder="Enter Admin Email">
                                    </div>
                                    <div class="form-group">
                                        <label for="ground_description">Ground description</label>
                                        <input type="text" class="form-control" id="ground_description" name="ground_description" value="" required placeholder="Enter Admin Type">
                                    </div>
                                    <div class="form-group">
                                        <label for="ground_image">Ground Image</label>
                                        <input type="file" class="form-control" id="ground_image" name="ground_image" required accept="*">
