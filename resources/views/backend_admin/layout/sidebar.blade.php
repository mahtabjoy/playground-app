<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ url('admin/dashboard') }}"> <img alt="image" src="{{ asset('backend_admin/assets/img/logo.png') }}" class="header-logo" /> <span
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ url('new_admin/create') }}">New Admin</a></li>
                    <li><a class="nav-link" href="{{ url('new_admin/list') }}">Admin list</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="" class="menu-toggle nav-link has-dropdown"><i
                        data-feather="briefcase"></i><span>Play Ground</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ url('play_ground/create') }}">New Play Ground</a></li>
                    <li><a class="nav-link" href="{{ url('play_ground/list') }}">Play Ground list</a></li>
                </ul>
            </li>
            @else
            <li class="dropdown">
